...
function render() {
    ...
    function noise1(x, y) {
        ...
        //return Math.sin(x * -0.4) * 5 + Math.sin(2 * x + y * 0.5) * 3;
        var xRand = getRandomInt(38, 40);
        var yRand = getRandomInt(45, 48);
        //var newX = allStreamData[xRand] / 255;
        //var newY = allStreamData[yRand] / 255;
    ...
    function noise2(x, y) {
        //return(Math.sin(y*0.2) +Math.sin((x+(y*0.6))*0.2)) * 4;
        //return Math.sin(x * -0.4) * 5 + Math.sin(2 * x + y * 0.5) * 3;
        var xRand = getRandomInt(48, 50);
        var yRand = getRandomInt(55, 58);
        //var newX = allStreamData[xRand] / 255;
        //var newY = allStreamData[yRand] / 255;
        var xScale = allStreamData[xRand] / 255;
        var yScale = allStreamData[yRand] / 255;
    ...
    function drawLand() {
        ...
        var p2d = [0, -00];
        for (var slicez = 50; slicez >= 10; slicez--) {
            c.beginPath();
